<!-- <template>
    <div class="h-auto w-full px-6 md:px-20 text-sm md:text-lg text-zinc-400">
        <div class="w-full md:w-4/5 flex flex-col">
            <div><p class="text-3xl font-extralight md:text-6xl">NewTribe Gathering</p></div>
            <div class="w-full flex flex-col space-y-5 md:space-y-0 md:flex-row space-x-0 md:space-x-9 mt-5 md:mt-10">
...
<template>
    <div class=" h-auto w-full text-sm md:text-lg text-zinc-400">        
        <div class="w-full bg-zinc-700/40 backdrop-blur-sm flex flex-col px-6 md:px-20 py-12 md:py-28">
            <div><p class="text-3xl font-extralight md:text-6xl">NewTribe Gathering</p></div>
            <div><p class="w-full text-justify md:w-1/2 mt-5 md:mt-10">NewTribe Gathering is a private, invite-only networking event focusing on ‘Network State’ and fostering a close-knit community of Web3 innovators believing in true decentralization and creating a global impact.</p></div>
            <div><p class="w-full text-justify md:w-1/2 mt-5 md:mt-10">The first edition of NewTribe Gathering witnessed 100+ C-suite executives, senior professionals, regulatory officials, and government representatives.  After the success of the first edition, the NewTribe team is all set to come up with further editions of the 'NewTribe Gathering' on a bigger and better scale!</p></div>
        </div>
