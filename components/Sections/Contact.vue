<template>
    <div class="h-auto w-full text-sm md:text-lg text-zinc-400 flex flex-col px-6 md:px-20">
        <div class="w-full md:w-4/5 bg--700 flex flex-col">
            <span v-for="(item, index) in items" :key="index">
              <div :class="`relative`">
                <div @click="toggleAcco(item.id)" role="accordion" class="border sticky top-0 cursor-pointer border-zinc-700 p-4 md:p-9 flex flex-row justify-between items-center" :class="activeAccoID == item.id? `bg-zinc-900`:``">
                    <p class="text-xl md:text-5xl">{{item.question}} <br>{{item.question2}}</p>
                    <div>
                ...
                <div v-show="activeAccoID == item.id" class="mt-5">
                  <span class="flex w-full flex-row justify-between">
                    <div class="border border-zinc-700 p-4 md:p-9 w-full flex flex-col justify-between items-center">
                        ...
                        <form class="w-full flex flex-col md:flex-row space-x-0 md:space-x-9 mt-10">
                            <div class="w-full md:w-1/2 flex flex-col space-y-5 justify-between">
                                ...
                                <div class="flex flex-col space-y-2">
                                    <div class="flex flex-row space-x-2 items-center">
                                        <input v-model="data.defi" type="checkbox" id="defi" class="w-5 h-5 accent-zinc-700 focus:accent-zinc-800 text-zinc-400 placeholder:text-zinc-500 focus:border-0 focus:outline-none" required />
                                        <label for="defi">DeFi</label>
                                    </div>
                                    <div class="flex flex-row space-x-2 items-center">
                                        <input v-model="data.smedia" type="checkbox" id="smedia" class="w-5 h-5 bg-zinc-700 focus:bg-zinc-800 text-zinc-400 placeholder:text-zinc-500 focus:border-0 focus:outline-none" required />
                                        <label for="smedia">Social Media</label>
                                    </div>
                                    <div class="flex flex-row space-x-2 items-center">
                                        <input v-model="data.nft" type="checkbox" id="nft" class="w-5 h-5 bg-zinc-700 focus:bg-zinc-800 text-zinc-400 placeholder:text-zinc-500 focus:border-0 focus:outline-none" required />
                                        <label for="nft">NFT</label>
                                    </div>
                                    <div class="flex flex-row space-x-2 items-center">
                                        <input v-model="data.gamefi" type="checkbox" id="gamefi" class="w-5 h-5 bg-zinc-700 focus:bg-zinc-800 text-zinc-400 placeholder:text-zinc-500 focus:border-0 focus:outline-none" required />
                                        <label for="gamefi">GameFi</label>
                                    </div>
                                    <div class="flex flex-row space-x-2 items-center">
                                        <input v-model="data.metaverse" type="checkbox" id="met.metaverse" class="w-5 h-5 bg-zinc-700 focus:bg-zinc-800 text-zinc-400 placeholder:text-zinc-500 focus:border-0 focus:outline-none" required />
                                        <label for="met.metaverse">Metaverse</label>
                                    </div>
                                    <div class="flex flex-row space-x-2 items-center">
                                        <input v-model="data.dsecurity" type="checkbox" id="dsecurity" class="w-5 h-5 bg-zinc-700 focus:bg-zinc-800 text-zinc-400 placeholder:text-zinc-500 focus:border-0 focus:outline-none" required />
                                        <label for="dsecurity">Data Security</label>
                                    </div>
                                    <div class="flex flex-row space-x-2 items-center">
                                        <input v-model="data.infraprotocol" type="checkbox" id="inf.infraprotocol" class="w-5 h-5 bg-zinc-700 focus:bg-zinc-800 text-zinc-400 placeholder:text-zinc-500 focus:border-0 focus:outline-none" required />
                                        <label for="inf.infraprotocol">Infrastucture Protocol</label>
                                    </div>
                                    <div class="flex flex-row space-x-2 items-center">
                                        <input v-model="data.layerzero" type="checkbox" id="layerzero" class="w-5 h-5 bg-zinc-700 focus:bg-zinc-800 text-zinc-400 placeholder:text-zinc-500 focus:border-0 focus:outline-none" required />
        ...
        <div class="w-full md:w-4/5 bg--700 flex flex-col mt-10">
            <div class="border border-zinc-700 flex flex-col md:flex-row justify-start md:justify-between items-center">
                <div class="w-full md:w-1/2 h-full border-r border-zinc-700 py-4 md:py-9 flex flex-col">
                    <div class="px-4 md:px-9 pb-4 md:pb-9 border-b border-zinc-700 flex flex-col text-2xl md:text-5xl">
                        <p>Drop your </p>
                        <p>message below </p>
                    </div>
                    <div class="px-4 md:px-9 pt-4 md:pt-9 flex flex-col">
                        ...
                        <div>
                            <form class="w-full flex flex-col space-y-4 mt-4">
                                ...
                                <button class="flex flex-row w-full bg-zinc-800 hover:bg-zinc-900 px-8 py-4 text-zinc-400 justify-between">
                                    <p>Submit</p>
