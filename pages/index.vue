    ...
    <div class="relative h-auto w-full flex flex-col">
        ...
        <div class="h-full w-full flex flex-col py-8">
            ...
            <div class="relative pb-12 md:pb-28">                
                <div class="absolute hidden md:block h-64 w-24 right-3 top-3"><div><p class="mt-10 text-6xl font-bold text-zinc-700 transform rotate-90 bg-">#SUPPORT</p></div></div>
                <SectionsEcosystemSupport />
            </div>
            <div class="relative pb-12 md:pb-28">
                <div class="absolute hidden md:block h-64 w-24 right-3 top-3"><div><p class="mt-10 text-6xl font-bold text-zinc-700 transform rotate-90 bg-">#FOLIO</p></div></div>
            ...
            <div class="relative pb-12 md:pb-28">                
                <div class="absolute hidden md:block h-64 w-24 right-3 top-3"><div><p class="mt-10 text-6xl font-bold text-zinc-700 transform rotate-90 bg-">#CONNECT</p></div></div>
                <SectionsContact />
            </div>
        </div>
    </div>
